...
const WHAT_WE_AUTOMATE = [
  ...
  },
  {
    ...
    body: "24/7 call answering, lead qualification, and appointment booking. A natural-sounding AI voice agent answers your calls, checks your calendar, and books appointments in real time. You never miss a call again.",
    cta: "AI Voice Agents →",
  },
  {
